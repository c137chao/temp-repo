...
data = np.array(
    [
       [85, 35, 0],[165, 55, 0],
       [65, 65, 0],[105, 75, 0],[145, 85, 0], [185, 95, 0], 
       [45, 105, 0], [85, 115, 0], [125, 125, 1], [165, 135, 1], [205, 145, 1],
       [65, 155, 1], [105, 165, 1], [145, 175, 1], [185, 185, 1],
         [85, 195, 1], [165, 215, 1],
    ])
...
krig_matrix_2 = krige_impl.Kriging(slug_data[:, 0], slug_data[:, 1], slug_data[:, 2], model='spherical', parameter=sep_dict) 
